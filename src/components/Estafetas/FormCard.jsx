...
function FormCard() {
    ...
    const { ItemsEstafetas, updateEstafetaInDB, setItemsEstafetas, addEstafeta } = useItemsEstafetasContext();
    ...
    const handleConfirmSave = async () => {
        ...
        // Crea un objeto con los datos de la nueva estafeta
        const newOficina = {
        ...
        console.log("Datos a crear:", newOficina);

        try {
            // Llama a la función para agregar la nueva estafeta en la base de datos
            await addEstafeta(newOficina); // Ahora debería funcionar correctamente
